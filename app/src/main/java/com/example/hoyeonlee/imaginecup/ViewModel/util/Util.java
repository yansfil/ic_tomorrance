package com.example.hoyeonlee.imaginecup.ViewModel.util;
...
public final class Util {
    ...
    private static float getDensityScalar() {
        return _Application.getInstance().getResources().getDisplayMetrics().density;
    }
    ...
    private static String readTextFileFromRawRes(@RawRes int resourceId) {
        InputStream inputStream = _Application.getInstance().getResources()
